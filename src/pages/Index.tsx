        ...
        <section className="container mx-auto px-4 py-20 md:py-28">
          <div className="mx-auto max-w-4xl text-center animate-fade-in">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              We pull resumes from your ATS, auto-create role-specific hiring factors, weight them by importance, and score each resume — all at just ₹0.8 or $0.01 per resume, saving 92% cost over traditional screening.
            </p>
